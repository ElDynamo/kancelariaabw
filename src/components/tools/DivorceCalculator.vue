<template>
  <div class="divorce-calculator font-sans">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      ...
      <div class="space-y-5">
        <div>
          <label class="block text-xs uppercase tracking-widest text-gold mb-2">Tryb orzekania o winie</label>
        ...
        <div>
          <label class="block text-xs uppercase tracking-widest text-gold mb-2">Dzieci</label>
        ...
        <div v-if="form.dzieci === 'tak'">
          <label class="block text-xs uppercase tracking-widest text-gold mb-2">Spór o opiekę nad dziećmi?</label>
          <div class="grid grid-cols-2 gap-3">
        ...
        <div>
          <label class="block text-xs uppercase tracking-widest text-gold mb-2">Podział majątku</label>
          <div class="grid grid-cols-2 gap-3">
        ...
        <div>
          <label class="block text-xs uppercase tracking-widest text-gold mb-2">Reprezentacja prawna</label>
          <div class="space-y-2">
      ...
      <div class="bg-navy rounded-2xl p-6 flex flex-col justify-between">
        <div>
          <p class="text-xs text-white/40 uppercase tracking-widest mb-4">Szacunkowe koszty</p>
          ...
          <div class="bg-white/10 rounded-xl p-4 mb-4">
            <p class="text-xs text-white/50 uppercase tracking-widest mb-1">Łączny koszt (szacunek)</p>
            <p class="text-3xl font-serif text-gold font-bold">{{ totalMin }} – {{ totalMax }}</p>
            <p class="text-xs text-white/50 mt-1">wartości w PLN (brutto)</p>
          </div>

          <div class="bg-white/5 rounded-xl p-4">
            <p class="text-xs text-white/50 uppercase tracking-widest mb-2">⏱ Szacowany czas</p>
        ...
        <div class="mt-6">
          ...
          <p class="text-xs text-white/30 text-center mt-2">Sprawdź czy Twój wynik jest typowy</p>
        </div>
      </div>
    </div>
