  ...
  <div class="statute-calculator font-sans">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-8">
      ...
      <div class="lg:col-span-5 relative">
        <div :class="['rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-between sticky top-32 border border-white/10 shadow-xl shadow-navy/10 min-h-[500px] overflow-hidden transition-colors duration-700', statusBg]">
