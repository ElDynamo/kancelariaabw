  ...
  <div class="alimony-calculator font-sans">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      <div class="space-y-5">
        ...
        <div>
          <label class="block text-xs font-semibold uppercase tracking-widest text-navy opacity-70 mb-2">Wiek dziecka</label>
        ...
        <div>
          <label class="block text-xs font-semibold uppercase tracking-widest text-navy opacity-70 mb-2">Liczba dzieci</label>
        ...
        <div>
          <label class="block text-xs font-semibold uppercase tracking-widest text-navy opacity-70 mb-2">Rodzaj opieki</label>
        ...
        <!-- Dodatkowe koszty -->
        <div>
          <label class="block text-xs font-semibold uppercase tracking-widest text-navy opacity-70 mb-2">Dodatkowe okoliczności</label>
          <div class="space-y-2">
      ...
      <div class="bg-navy rounded-2xl p-6 flex flex-col justify-between">
        <div>
          <p class="text-xs text-white opacity-70 uppercase tracking-widest font-semibold mb-2">Szacunkowe alimenty</p>
          <p class="text-5xl font-serif text-gold font-bold mb-1">
            {{ alimentyMin }}–{{ alimentyMax }}
          </p>
          <p class="text-sm text-white opacity-70 mb-6">zł miesięcznie / dziecko</p>

          <div class="space-y-3">
            <div class="bg-white/5 rounded-xl p-4">
              <p class="text-xs text-white opacity-70 uppercase tracking-wide font-semibold mb-1">Fundusz Alimentacyjny (max)</p>
              <p class="text-white text-sm">1 000 zł/mies. (od X 2024)</p>
              <p class="text-white opacity-60 text-xs">Tylko przy bezskutecznej egzekucji + dochód ≤ 900 zł/os.</p>
            </div>
            <div class="bg-white/5 rounded-xl p-4">
              <p class="text-xs text-white opacity-70 uppercase tracking-wide font-semibold mb-1">Świadczenie 800+</p>
              <p class="text-white opacity-70 text-xs">Nie zmniejsza alimentów (KRiO art. 135 § 3)</p>
            </div>
            <div class="bg-white/5 rounded-xl p-4">
              <p class="text-xs text-white opacity-70 uppercase tracking-wide font-semibold mb-1">Udział w możliwościach</p>
